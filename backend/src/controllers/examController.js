...
exports.createExam = async (req, res) => {
    try {
        ...
        const exam = await Exam.create({ title, duration, type, exam_date, course_id, user_id });
...
exports.updateExam = async (req, res) => {
    try {
        const { title, duration, type, exam_date, course_id, user_id } = req.body;
        const [updated] = await Exam.update({ title, duration, type, exam_date, course_id, user_id }, {
